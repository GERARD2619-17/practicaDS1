...
<c:if test="${resultado!=null}">
    ...
    <c:if test="${resultado==0}">
        ...
        <div class="busqueda" style="width: 50%; text-align: right">
            <form action="${pageContext.servletContext.contextPath}/Usuarios2" method="get">
                <input type="text" name="txtBusqueda" id="txtBusqueda" value="${valor}" />
                <input type="submit" value="Buscar"/></form></div>             
                <div class="buttons" ><ul>        
                        <li><a href="${pageContext.servletContext.contextPath}/Usuarios2?accion=insertar">Nuevo</a></li></ul></div>            
                        <br/>${tabla}
                        <script>            
